    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Tentang — isi navigasi dipindah ke sini */}
          <div>
          ...
          {/* Sosial Media */}
          <div>
            <h4 className="text-white font-semibold mb-3 text-sm">Sosial Media</h4>
            <ul className="space-y-3 text-sm">
              <li>
                <a
                  href="https://www.tiktok.com/@fitanaid"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2.5 hover:text-emerald-400 transition-colors group"
                >
                  <span className="w-7 h-7 rounded-lg bg-gray-800 group-hover:bg-gray-700 flex items-center justify-center transition-colors flex-shrink-0">
              ...
              <li>
                <a
                  href="https://www.youtube.com/@fitanaid"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2.5 hover:text-emerald-400 transition-colors group"
                >
              ...
              <li>
                <a
                  href="https://www.instagram.com/fitanaid"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2.5 hover:text-emerald-400 transition-colors group"
                >
